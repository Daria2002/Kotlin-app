...
class AddReviewAdapter(private val listPosts: MutableList<Post>, private val listener: View.OnClickListener) : RecyclerView.Adapter<AddReviewAdapter.ReviewViewHolder>() {
